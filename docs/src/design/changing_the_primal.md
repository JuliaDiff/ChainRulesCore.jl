...
Conceptually, for a particular instance of an operation the `PullbackMemory` is a fixed thing: it could be recorded as a hardcoded literal on the the tape.
